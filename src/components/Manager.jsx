                ...
                <div className="flex flex-col p-4 text-black gap-5 items-center">
                    ...
                    <div className="flex w-full justify-between gap-8">
                        ...
                        <div className="relative">
                            <input value={form.password} onChange={handleChange} placeholder="Enter Password" type="text" className='rounded-full border border-green-500 w-full px-4 py-1' name="password" id="" />
